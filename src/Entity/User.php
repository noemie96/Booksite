...
class User implements UserInterface
{
     ...
     * @Assert\Length(min=50, minMessage="Votre description doit faire au minimum 50 caractères")
     */
    private $description;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Books::class, mappedBy="utilisateur")
     */
    private $books;
